...
// any existing balzar file/behavior — it is a self-contained, additive
// module used by fountain-qr.html (the experimental web demo page) and
// by the original prototype in experiments/fountain-qr-poc/. No balzar
// engine code (payload.py/qr.py) is involved: this is a client-side-only
// carrier evaluated as a candidate ADDITION, not a replacement — see
// CLAUDE.md §13.
