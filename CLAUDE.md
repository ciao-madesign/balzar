...
301 test, tutti verdi (`python3 -m unittest discover -s tests`):
...
```bash
python3 -m unittest discover -s tests        # 301 test (alcuni opzionali su qrcode/pyzbar), deve restare verde
